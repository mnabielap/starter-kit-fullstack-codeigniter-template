...
class AuthService
{
    ...
    public function logout(string $refreshToken): void
    {
        ...
        // Soft delete or Hard delete based on preference. Here we hard delete.
    ...
    {
        try {
            $tokenDoc = $this->tokenService->verifyToken($token, $this->config->tokenTypes['RESET_PASSWORD']);
            $user = $this->userService->getUserById($tokenDoc->user_id);
    ...
    {
        try {
            $tokenDoc = $this->tokenService->verifyToken($token, $this->config->tokenTypes['VERIFY_EMAIL']);
            $user = $this->userService->getUserById($tokenDoc->user_id);
