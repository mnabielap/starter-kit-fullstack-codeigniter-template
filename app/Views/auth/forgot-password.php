...
<form id="forgotForm">
    ...
    <div class="mt-4 text-center">
        <p class="mb-0">Wait, I remember my password... <a href="<?= base_url('login') ?>" class="fw-semibold text-primary text-decoration-underline"> Click here </a> </p>
    </div>
...
<script>
    document.getElementById('forgotForm').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            // The API returns 204 No Content on success (or fake success for security)
            if (response.ok) {
